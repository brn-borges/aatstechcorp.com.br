...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dash sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="solicitacao.php" data-target="#collapsePages"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a type="button" class="d-none d-sm-inline-block btn btn-sm btn-outline-dark shadow-sm" data-toggle="modal" data-target="#criarContaModal">
                        Criar Conta</a>
                    </div>
    ...
    <div class="modal fade" id="visContaModal" tabindex="-1" aria-labelledby="visContaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="visContaModalLabel">Detalhes da Conta</h5>
                ...
                <div class="modal-body">
                    ...
                    <dl class="row">
                        ...
                        <dd class="col-sm-9"><span id="idConta"></span></dd>

                        <dt class="col-sm-3">Nome:</dt>
                        <dd class="col-sm-9"><span id="nomeConta"></span></dd>

                        <dt class="col-sm-3">Telefone:</dt>
                        <dd class="col-sm-9"><span id="telefoneConta"></span></dd>

                        <dt class="col-sm-3">E-mail:</dt>
                        <dd class="col-sm-9"><span id="emailConta"></span></dd>
    ...
    <div class="modal fade" id="criarContaModal" tabindex="-1" aria-labelledby="criarContaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="criarContaLabel">Cadastrar Conta</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="cad-conta-form">
                        <span id="msgAlertaErroCad"></span>
                        <span id="msgAlerta"></span>
                        <div class="mb-3">
                            <label for="nome" class="col-form-label">Nome:</label>
                            <input type="text" name="nome_user" class="form-control" id="nome_user" placeholder="Nome Completo">
                        </div>
                        <div class="mb-3">
                            <label for="cel" class="col-form-label">Celular:</label>
                            <input type="cel" name="telefone_user" class="form-control" id="telefone_user" placeholder="Celular" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);">
                            
                        </div>
                        <div class="mb-3">
                            <label for="Email" class="col-form-label">E-mail:</label>
                            <input type="email" name="email_user" class="form-control" id="email_user" placeholder="E-mail">
                        </div>
                        <div class="mb-3">
