...
<body id="page-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="mb-0 text-gray-800 font-weight-bold text-primary">Contas Cadastradas</h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="mb-0 text-gray-800 font-weight-bold text-primary">Estatisticas de Cadastro</h6>
    ...
    <script src="js/demo/chart-user.js"></script>
