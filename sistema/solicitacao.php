            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="forgot-password.html">Exbir Dúvidas/Sugestões</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="col-xl-8 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="mb-0 text-gray-800 font-weight-bold text-primary">Dúvidas e Sugestões</h6>
                                ...
                                <div class="card-body">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>E-mail</th>
                                                <th>Telefone</th>
                                                <th>Dúvida ou Sugestão</th>
                                             </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="select">
                                                <?php 
                                                    while($row = mysqli_fetch_array($solicitacaocriadas)){ 
                                                    print "<td style='text-align: center; 
                                                    vertical-align: middle;'>".$row['id_form'] . "</td><td>" . $row['nome_form'] . "</td><td>" . $row['email_form']. "</td><td> " . $row['telefone_form'] . "</td> <td>" . $row['duvida_form']. "</td></tr>" ; }
                                                    ?>
                                        </tbody>
                                        </table>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="mb-0 text-gray-800 font-weight-bold text-primary">Estatisticas de Dúvidas e Sugestões</h6>
