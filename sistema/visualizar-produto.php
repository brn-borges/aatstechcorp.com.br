...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dash sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="solicitacao.php"  data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
                ...
                <div class="modal-body">
                    <form id="cad-produto-form">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="desc_produt" class="form-control" id="desc_produt" placeholder="Descrição do Produto"></textarea>
                        </div>
                        <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <dl class="row">
                        ...
                        <dt class="col-sm-3">Valor Unitário: R$</dt>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-produto-form">
                        ...
                        <div class="mb-3">
                            <label for="nome" class="col-form-label">Produto:</label>
                            <input type="text" name="nome_produt" class="form-control" id="editnome" placeholder="Nome do Produto">
                        </div>
                        <div class="mb-3">
                            <label for="qtde" class="col-form-label">Qtde.:</label>
                        ...
                        <div class="mb-3">
                            <label for="text" class="col-form-label">Descrição Produto:</label>
                            <textarea type="text" name="desc_produt" class="form-control" id="editdesc" placeholder="Descrição do Produto"></textarea>
                        </div>
                        <div class="modal-footer">
